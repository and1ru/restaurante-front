    ...
    <main className="p-10">
        <div className="p-10 shadow-2xl rounded-lg shadow-black/70">
            ...
            <form onSubmit={handleForm}>
                <input type="text" placeholder="nombre restaurante" className="p-2 shadow-lg rounded-lg mb-5 w-full" />
                ...
                <input type="password" placeholder="confrim password" className="p-2 shadow-lg rounded-lg mb-5 w-full" />
                <button 
                onClick={handleClick}
